...
Build a robust cache manager implementation with clear module boundaries and predictable behavior.
...
```bash
node -e "const m=require('./projects/02-intermediate/10-cache-manager/solution/index.solution'); console.log(m.metadata);"
```
