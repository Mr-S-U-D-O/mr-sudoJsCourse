...
Build a robust http request interceptor implementation with clear module boundaries and predictable behavior.
...
```bash
node -e "const m=require('./projects/02-intermediate/08-http-request-interceptor/solution/index.solution'); console.log(m.metadata);"
```
