...
Build a robust temperature converter implementation with clear module boundaries and predictable behavior.
...
```bash
node -e "const m=require('./projects/01-beginner/03-temperature-converter/solution/index.solution'); console.log(m.metadata);"
```
