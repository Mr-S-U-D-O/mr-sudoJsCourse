...
Build a robust shopping cart implementation with clear module boundaries and predictable behavior.
...
```bash
node -e "const m=require('./projects/01-beginner/08-shopping-cart/solution/index.solution'); console.log(m.metadata);"
```
