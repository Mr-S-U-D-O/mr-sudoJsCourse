...
**Difficulty:** 🟢 Beginner | **Time:** 5-8 hours | **Focus:** state machines, transition validation, audit trail
...
```bash
node -e "const m=require('./projects/01-beginner/05-simple-todo-tracker/src'); console.log('Starter exports:', Object.keys(m));"
node -e "const m=require('./projects/01-beginner/05-simple-todo-tracker/solution/index.solution'); console.log('Solution exports:', Object.keys(m));"
```
