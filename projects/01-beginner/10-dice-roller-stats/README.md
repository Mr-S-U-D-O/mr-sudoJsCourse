...
Build a robust dice roller stats implementation with clear module boundaries and predictable behavior.
...
```bash
node -e "const m=require('./projects/01-beginner/10-dice-roller-stats/src'); console.log(Object.keys(m));"
```

2. Run the reference solution

```bash
node -e "const m=require('./projects/01-beginner/10-dice-roller-stats/solution/index.solution'); console.log(m.metadata);"
```
