...
Build a robust password strength checker implementation with clear module boundaries and predictable behavior.
...
```bash
node -e "const m=require('./projects/01-beginner/06-password-strength-checker/solution/index.solution'); console.log(m.metadata);"
```
