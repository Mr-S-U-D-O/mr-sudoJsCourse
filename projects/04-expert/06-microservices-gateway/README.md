...
```bash
node -e "const m=require('./projects/04-expert/06-microservices-gateway/src'); console.log('Starter exports:', Object.keys(m));"
node -e "const m=require('./projects/04-expert/06-microservices-gateway/solution/index.solution'); console.log('Solution exports:', Object.keys(m));"
```
