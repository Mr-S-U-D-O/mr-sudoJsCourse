...
```bash
node -e "const m=require('./projects/04-expert/10-performance-profiler/src'); console.log('Starter exports:', Object.keys(m));"
node -e "const m=require('./projects/04-expert/10-performance-profiler/solution/index.solution'); console.log('Solution exports:', Object.keys(m));"
```
