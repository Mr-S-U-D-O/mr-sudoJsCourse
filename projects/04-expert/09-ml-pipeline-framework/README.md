...
```bash
node -e "const m=require('./projects/04-expert/09-ml-pipeline-framework/src'); console.log('Starter exports:', Object.keys(m));"
node -e "const m=require('./projects/04-expert/09-ml-pipeline-framework/solution/index.solution'); console.log('Solution exports:', Object.keys(m));"
```
