...
```bash
node -e "const m=require('./projects/04-expert/08-consensus-algorithm/src'); console.log('Starter exports:', Object.keys(m));"
node -e "const m=require('./projects/04-expert/08-consensus-algorithm/solution/index.solution'); console.log('Solution exports:', Object.keys(m));"
```
