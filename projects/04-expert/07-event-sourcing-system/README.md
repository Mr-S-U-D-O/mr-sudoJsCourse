...
```bash
node -e "const m=require('./projects/04-expert/07-event-sourcing-system/src'); console.log('Starter exports:', Object.keys(m));"
node -e "const m=require('./projects/04-expert/07-event-sourcing-system/solution/index.solution'); console.log('Solution exports:', Object.keys(m));"
```
