...
```bash
node -e "const m=require('./projects/04-expert/05-query-optimizer/src'); console.log('Starter exports:', Object.keys(m));"
node -e "const m=require('./projects/04-expert/05-query-optimizer/solution/index.solution'); console.log('Solution exports:', Object.keys(m));"
```
