...
```bash
node -e "const m=require('./projects/03-advanced/05-data-migration-engine/src'); console.log('Starter exports:', Object.keys(m));"
node -e "const m=require('./projects/03-advanced/05-data-migration-engine/solution/index.solution'); console.log('Solution exports:', Object.keys(m));"
```
