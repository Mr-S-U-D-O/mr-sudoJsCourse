...
Build a robust graphql api builder implementation with clear module boundaries and predictable behavior.
...
```bash
node -e "const m=require('./projects/03-advanced/09-graphql-api-builder/solution/index.solution'); console.log(m.metadata);"
```
