...
```bash
node -e "const m=require('./projects/03-advanced/09-graphql-api-builder/src'); console.log('Starter exports:', Object.keys(m));"
node -e "const m=require('./projects/03-advanced/09-graphql-api-builder/solution/index.solution'); console.log('Solution exports:', Object.keys(m));"
```
