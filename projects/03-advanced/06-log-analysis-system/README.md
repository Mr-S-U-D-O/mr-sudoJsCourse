...
Build a robust log analysis system implementation with clear module boundaries and predictable behavior.
...
```bash
node -e "const m=require('./projects/03-advanced/06-log-analysis-system/src'); console.log(Object.keys(m));"
```

2. Run the reference solution

```bash
node -e "const m=require('./projects/03-advanced/06-log-analysis-system/solution/index.solution'); console.log(m.metadata);"
```
