...
```bash
node -e "const m=require('./projects/03-advanced/06-log-analysis-system/src'); console.log('Starter exports:', Object.keys(m));"
node -e "const m=require('./projects/03-advanced/06-log-analysis-system/solution/index.solution'); console.log('Solution exports:', Object.keys(m));"
```
