...
## Challenge
Implement the function in 03-Prototypes.js.
...
- Return an object with these fields:
  - topic: the exact label "Prototypes".
...
## Pass Condition
Run: npm run check 03-Hard-Architecture/03-Prototypes
