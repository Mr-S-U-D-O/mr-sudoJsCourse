...
## Challenge
Implement the function in 07-Async-Await.js.
...
- Return an object with these fields:
  - topic: the exact label "Async-Await".
...
## Pass Condition
Run: npm run check 03-Hard-Architecture/07-Async-Await
