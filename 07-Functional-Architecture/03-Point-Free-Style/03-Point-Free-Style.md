...
- Lesson target: Point Free Style
...
## Challenge
Implement the function in 03-Point-Free-Style.js.
...
- Return an object with these fields:
  - topic: the exact label "Point-Free-Style".
...
## Pass Condition
Run: npm run check 07-Functional-Architecture/03-Point-Free-Style
