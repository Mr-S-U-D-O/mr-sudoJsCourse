...
- Lesson target: Reactive Programming
...
## Challenge
Implement the function in 06-Reactive-Programming.js.
...
- Return an object with these fields:
  - topic: the exact label "Reactive-Programming".
...
## Pass Condition
Run: npm run check 07-Functional-Architecture/06-Reactive-Programming
