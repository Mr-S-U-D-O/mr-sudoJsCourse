...
- Lesson target: Monads and Functors
...
## Challenge
Implement the function in 04-Monads-and-Functors.js.
...
- Return an object with these fields:
  - topic: the exact label "Monads-and-Functors".
...
## Pass Condition
Run: npm run check 07-Functional-Architecture/04-Monads-and-Functors
