...
## Challenge
Implement the function in 01-Pure-Functions.js.
...
- Return an object with these fields:
  - topic: the exact label "Pure-Functions".
...
## Pass Condition
Run: npm run check 07-Functional-Architecture/01-Pure-Functions
