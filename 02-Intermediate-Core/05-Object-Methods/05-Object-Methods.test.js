...
describe('Object-Methods', () => {
  ...
  test('Validation: throws when input is not an array', () => {
    expect(() => solveObjectMethods(null)).toThrow('values must be an array');
    expect(() => solveObjectMethods('not-an-array')).toThrow('values must be an array');
  });
