...
## Challenge
Implement the function in 06-Destructuring.js.
...
- Return an object with these fields:
  - topic: the exact label "Destructuring".
...
## Pass Condition
Run: npm run check 02-Intermediate-Core/06-Destructuring
