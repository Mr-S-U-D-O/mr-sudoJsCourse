...
- Lesson target: Scope and Hoisting
...
## Challenge
Implement the function in 01-Scope-and-Hoisting.js.
...
- Return an object with these fields:
  - topic: the exact label "Scope-and-Hoisting".
...
## Pass Condition
Run: npm run check 02-Intermediate-Core/01-Scope-and-Hoisting
