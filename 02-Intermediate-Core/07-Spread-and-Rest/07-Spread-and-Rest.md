...
## Challenge
Implement the function in 07-Spread-and-Rest.js.
...
- Return an object with these fields:
  - topic: the exact label "Spread-and-Rest".
...
## Pass Condition
Run: npm run check 02-Intermediate-Core/07-Spread-and-Rest
