...
- Lesson target: Template Literals
...
## Challenge
Implement the function in 03-Template-Literals.js.
...
- Return an object with these fields:
  - topic: the exact label "Template-Literals".
...
## Pass Condition
Run: npm run check 02-Intermediate-Core/03-Template-Literals
