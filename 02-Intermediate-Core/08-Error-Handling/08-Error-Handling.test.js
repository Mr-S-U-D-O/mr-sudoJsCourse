...
describe('Error-Handling', () => {
  ...
  test('Validation: throws when input is not an array', () => {
    expect(() => solveErrorHandling(null)).toThrow('values must be an array');
    expect(() => solveErrorHandling('not-an-array')).toThrow('values must be an array');
  });
