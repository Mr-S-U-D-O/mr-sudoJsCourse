...
## Challenge
Implement the function in 08-Error-Handling.js.
...
- Return an object with these fields:
  - topic: the exact label "Error-Handling".
...
## Pass Condition
Run: npm run check 02-Intermediate-Core/08-Error-Handling
