...
## Challenge
Implement the function in 08-Objects-Basics.js.
...
- Return an object with these fields:
  - topic: the exact label "Objects-Basics".
...
## Pass Condition
Run: npm run check 01-Easy-Fundamentals/08-Objects-Basics
