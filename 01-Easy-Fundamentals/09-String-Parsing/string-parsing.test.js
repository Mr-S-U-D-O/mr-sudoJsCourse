...
console.assert(JSON.stringify(result1) === JSON.stringify(["2", "+", "3", "*", "4"]), "Failed");

console.log("Test 2: No whitespace");
const result2 = sp.tokenizeExpression("10*5+3");
console.log(result2); // ["10", "*", "5", "+", "3"]
console.assert(JSON.stringify(result2) === JSON.stringify(["10", "*", "5", "+", "3"]), "Failed");
...
console.assert(JSON.stringify(csv) === JSON.stringify(["John", "30", "NYC"]), "Failed");
...
console.assert(JSON.stringify(vars) === JSON.stringify(["name", "age"]), "Failed");
