...
## Why This Matters
let is one of the most frequent sources of scope bugs in JavaScript interviews and production incidents.
...
## Challenge
Implement the function in 02-let.js.
...
## Pass Condition
Run: npm run check 01-Easy-Fundamentals/01-Variables/02-let

## Learning Resources
- https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/let
- https://javascript.info/let-const
