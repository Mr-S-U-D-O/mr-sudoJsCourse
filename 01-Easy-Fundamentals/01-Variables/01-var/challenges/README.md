...
This folder has optional, simple practice split by challenge folders.
...
- `challenge.js` (starter)
- `solutions/challenge.solution.js` (reference)
- `challenge.test.js` (check)
- `README.md` (instructions + enrichment)

## Run

Run any one challenge test:
