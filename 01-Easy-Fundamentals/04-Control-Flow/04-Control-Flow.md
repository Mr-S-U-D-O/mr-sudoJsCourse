...
## Challenge
Implement the function in 04-Control-Flow.js.
...
- Return an object with these fields:
  - topic: the exact label "Control-Flow".
...
## Pass Condition
Run: npm run check 01-Easy-Fundamentals/04-Control-Flow
