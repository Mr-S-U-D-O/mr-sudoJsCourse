...
- Lesson target: Advanced Networking
...
## Challenge
Implement the function in 06-Advanced-Networking.js.
...
- Return an object with these fields:
  - topic: the exact label "Advanced-Networking".
...
## Pass Condition
Run: npm run check 06-The-Platform/06-Advanced-Networking
