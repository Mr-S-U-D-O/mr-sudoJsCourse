...
- Lesson target: Web and Service Workers
...
## Challenge
Implement the function in 03-Web-and-Service-Workers.js.
...
- Return an object with these fields:
  - topic: the exact label "Web-and-Service-Workers".
...
## Pass Condition
Run: npm run check 06-The-Platform/03-Web-and-Service-Workers
