...
- Lesson target: Buffers and TypedArrays
...
## Challenge
Implement the function in 02-Buffers-and-TypedArrays.js.
...
- Return an object with these fields:
  - topic: the exact label "Buffers-and-TypedArrays".
...
## Pass Condition
Run: npm run check 06-The-Platform/02-Buffers-and-TypedArrays
