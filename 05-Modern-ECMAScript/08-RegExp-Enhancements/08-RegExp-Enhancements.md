...
- Lesson target: RegExp Enhancements
...
## Challenge
Implement the function in 08-RegExp-Enhancements.js.
...
- Return an object with these fields:
  - topic: the exact label "RegExp-Enhancements".
...
## Pass Condition
Run: npm run check 05-Modern-ECMAScript/08-RegExp-Enhancements
