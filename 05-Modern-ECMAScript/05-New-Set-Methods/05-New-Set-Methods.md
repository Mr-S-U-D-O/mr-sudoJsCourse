...
## Challenge
Implement the function in 05-New-Set-Methods.js.
...
- Return an object with these fields:
  - topic: the exact label "New-Set-Methods".
...
## Pass Condition
Run: npm run check 05-Modern-ECMAScript/05-New-Set-Methods
