...
- Lesson target: Explicit Resource Management
...
## Challenge
Implement the function in 01-Explicit-Resource-Management.js.
...
- Return an object with these fields:
  - topic: the exact label "Explicit-Resource-Management".
...
## Pass Condition
Run: npm run check 05-Modern-ECMAScript/01-Explicit-Resource-Management
