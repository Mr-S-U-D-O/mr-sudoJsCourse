...
## Challenge
Implement the function in 03-Decorators.js.
...
- Return an object with these fields:
  - topic: the exact label "Decorators".
...
## Pass Condition
Run: npm run check 05-Modern-ECMAScript/03-Decorators

## Escape Hatch
https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/decorators
