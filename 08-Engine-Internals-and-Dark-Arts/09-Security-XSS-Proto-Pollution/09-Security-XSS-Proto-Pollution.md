...
- Lesson target: Security XSS Proto Pollution
...
## Challenge
Implement the function in 09-Security-XSS-Proto-Pollution.js.
...
- Return an object with these fields:
  - topic: the exact label "Security-XSS-Proto-Pollution".
