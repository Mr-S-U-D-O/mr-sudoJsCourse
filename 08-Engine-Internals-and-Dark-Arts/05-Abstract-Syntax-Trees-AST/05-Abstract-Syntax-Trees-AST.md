...
- Lesson target: Abstract Syntax Trees AST
...
## Challenge
Implement the function in 05-Abstract-Syntax-Trees-AST.js.
...
- Return an object with these fields:
  - topic: the exact label "Abstract-Syntax-Trees-AST".
...
## Pass Condition
Run: npm run check 08-Engine-Internals-and-Dark-Arts/05-Abstract-Syntax-Trees-AST

## Escape Hatch
https://developer.mozilla.org/en-US/docs/Glossary/Abstract_syntax_tree
