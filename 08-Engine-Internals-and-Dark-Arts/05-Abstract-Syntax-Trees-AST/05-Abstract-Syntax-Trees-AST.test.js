...
describe('Abstract-Syntax-Trees-AST', () => {
  ...
  test('Validation: throws when input is not an array', () => {
    expect(() => solveAbstractSyntaxTreesAST(null)).toThrow('values must be an array');
    expect(() => solveAbstractSyntaxTreesAST('not-an-array')).toThrow('values must be an array');
  });
  ...
  test('Safety: does not mutate the input array', () => {
    ...
    solveAbstractSyntaxTreesAST(input);
